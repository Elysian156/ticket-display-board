...
from models.passwords import fetch_last_password, createPassword, fetchPasswords, fecthOnePasswordByCode, \
    checkoutPassword, findPasswordWithPassword
from models.updateSpreadsheet import updateSpreadsheet, fetching_data
...
def search_user(cpf):
    ...
    if (user):
        ...
        deficiency = user[5]
        return jsonify(
            {'id': user_id, 'name': name, 'cpf': cpf, 'date_birthday': date_birthday, 'is_especial': is_especial,
...
def end():
    ...
    return jsonify({
                       "link_planilha": "https://docs.google.com/spreadsheets/d/1kdCSm6NCydh3mfUBuYATwlRnl_hbxQYYEUoUkJ0xdT8/edit?usp=sharing"})
